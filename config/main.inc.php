...
$rcmail_config['default_host'] = 'ssl://mail.keiser.com';
...
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['smtp_server'] = 'mail2.keiser.com';
...
$rcmail_config['smtp_user'] = 'keiser';

// SMTP password (if required) if you use %p as the password Roundcube
// will use the current user's password for login
$rcmail_config['smtp_pass'] = 'pumpair';
...
$rcmail_config['support_url'] = 'http://email.keiser.com/support';

// replace Roundcube logo with this image
// specify an URL relative to the document root of this Roundcube installation
$rcmail_config['skin_logo'] = 'skins/keiser_logo.png';
...
$rcmail_config['des_key'] = 'qo&Vt8*pRhElzk55NQP+iyNN';
...
$rcmail_config['product_name'] = 'Keiser Email';
...
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['junk_mbox'] = '';

// store sent message is this mailbox
// leave blank if sent messages should not be stored
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['sent_mbox'] = 'Copies to self';
...
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['default_folders'] = array('INBOX', 'Drafts', 'Copies to self', 'Trash');
...
$rcmail_config['spellcheck_languages'] = 'English';
